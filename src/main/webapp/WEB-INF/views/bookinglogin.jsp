      ...
      <script type="text/javascript">
      	document.addEventListener("DOMContentLoaded",function(){
      		...
      		document.querySelector(".login_btn").addEventListener("click",function(){
      			let email = document.querySelector(".login_input").value
      			if(RegExp.test(email)){
      				//sessionStorage.setItem("email",email) 안됌.
      				document.querySelector("#form1").setAttribute("onSubmit","return true")
      			}else{
	      			document.querySelector("#form1").setAttribute("onSubmit","return false")
