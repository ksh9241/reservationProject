...
<body>
			...
			<div class="wrap_review_list">
				<div class="review_header">
					<div class="top_title gr">
						<a href="./detail?id=${id}" class="btn_back" title="이전 화면으로 이동">
	...
	<script type="rv-template" id="noImgCommentSample">
			<li class="list_item">
                <div>
	...
	<script type="rv-template" id="ImgCommentSample">
		<li class="list_item">
			<div>
