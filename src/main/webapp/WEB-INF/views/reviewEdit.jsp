...
<body>
	<input type="hidden" value="${reservationInfoId}" id="reservationInfoId">
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="./myreservation?resrv_email=${email}" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
				...
				<!-- 리뷰 등록 -->
					<button class="bk_btn" style="margin-bottom:5px;"><span class="btn_txt">리뷰 수정</span></button>
				</div>
